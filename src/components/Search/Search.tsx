...
// import contextCurrentConvo from '../../Contexts/contextCurrentInbox'
...
// 	const [[results, n], setResults] = useState<[FuseResult<Message>[], number]>([[], -1])
...
// 	useEffect(() => {
// 		currentConvo && n != -1 && setRange(chunkRange(currentConvo, results[n].item.time, [6, 8]))
// 	}, [results, n])
...
// 					/>
// 					<input type="button" value="Search" onClick={() => currentConvo && search()} />
// 					<input type="button" value="Previous" onClick={() => browse(false)} />
